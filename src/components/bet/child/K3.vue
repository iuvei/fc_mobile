<template>
	<div class="ks">
		<div class="clockView">
			<div class="left">
				<p style="display: flex;align-items: center;text-align: center;justify-content: center;"><img src="../../../../static/img/lingdang.png" style="width: 0.3rem;margin-right:0.1rem;" />{{gameConfig[kindId].gameName}}第{{showPrevAwarPeriod}}期</p>
			...
			<div class="right">
				...
				<CountDown class="clock-count" :classId="classId" :kindId="kindId" :format="':'" style="font-size: 14px;color:#e43a45;" @stop="countDown"></CountDown>
			</div>
		</div>
			...
			<div class="content">
				...
				<div class="bet_list_ksSum" v-if="templateType.ksSumVal[subGameId]">
					...
					<div class="bet_box" v-if="betDataList.numbers">
						<div v-for="(item,index) in betDataList.numbers[0].cols" :key="index" style="display: flex;flex-direction: column;">
